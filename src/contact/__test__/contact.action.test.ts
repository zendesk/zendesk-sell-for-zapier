...
import {CreateCompanyAction, CreatePersonAction, UpdateCompanyAction, UpdatePersonAction} from '../contact.action'
...
describe('create contact person action', () => {
  it('should pass if person is properly created', async () => {
    ...
    const response = await appTester(App.creates[CreatePersonAction.key].operation.perform, bundle)
  ...
  it('should throw error with details if 4xx is returned from API while creating person', async () => {
    ...
    try {
      await appTester(App.creates[CreatePersonAction.key].operation.perform, bundle)
...
describe('create company action', () => {
  it('should pass if company is properly created', async () => {
    ...
    const response = await appTester(App.creates[CreateCompanyAction.key].operation.perform, bundle)
...
describe('update person action', () => {
  it('should pass if person is properly updated', async () => {
    ...
    const response = await appTester(App.creates[UpdatePersonAction.key].operation.perform, bundle)
...
describe('update company action', () => {
  it('should pass if company is properly updated', async () => {
    ...
    const response = await appTester(App.creates[UpdateCompanyAction.key].operation.perform, bundle)
