export const dealActions = {
  createDealAction: 'deal_create',
  updateDealAction: 'deal_update'
}

export const dealSearches = {
  dealSearchOrCreate: 'deal_search_v2'
}

export const dealTriggers = {
...
export const pipelineTriggers = {
  pipelineListDropdown: 'pipeline_list_dropdown'
}
