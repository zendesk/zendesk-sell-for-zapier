...
export const createActionDetails = (name: string): ActionDetails =>
  details(ActionType.Create, name)
export const triggerActionDetails = (name: string): ActionDetails =>
  details(ActionType.Trigger, name)
export const searchActionDetails = (name: string): ActionDetails =>
  details(ActionType.Search, name)
export const authActionDetails = (name: string): ActionDetails =>
  details(ActionType.OAuth2, name)
export const dropdownActionDetails = (name: string): ActionDetails =>
  details(ActionType.Dropdown, name)
...
export const applicationMetadataAppender = (
...
export const appSignatureAppender = (
  request: HttpRequestOptions
): HttpRequestOptions => {
  const headersToBeSigned = pickBy(request.headers, (v: any, k: string) =>
    startsWith(k, 'X-Clientapp')
  )
  appendHeader(
    request,
    'X-Clientapp-Signature',
    singPayload(headersToBeSigned)
  )
  return request
}
